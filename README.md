...
Utilicé 2 archivos .HTML para representar la página principal y otra que confirma el envío del formulario. Y realice un menú de navegación para poder ver cada una de las secciones de la página.
